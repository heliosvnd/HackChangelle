...
<body ng-app="app" ng-controller="validarForm">
  ...
  <div class="pageHome">
     ...
     <div id="effect" class="ui-widget-content ui-corner-all">
      <div id="menuPrincipal">
        <div class="header-usuario">
          ...
          <div id="inf-usuario">Menú Principal<br></div>
        </div>
        <div id="buscador">
						...
						<ul class="nivel2"> 
							...
							<li>
								...
								<ul class="nivel3 fix1"> 
									<li><a  href="index.html"><p>Tarjeta de Crédito Oro</p></a></li>
									<li><a  href="index.html"><p>Tarjeta de Crédito Elektra</p></a></li>
									<li><a  href="index.html"><p>Tarjeta Azteca</p></a></li>
									<li><a  href="index.html"><p>Tarjeta de Crédito Clásica</p></a></li>
								</ul>
							</li>
							<li><a  href="index.html"><p>Inversión</p></a></li>
      	...
      	<div class="blanco">
         	<div class="w80">
			  ...
			  <div class="divGrow">
				<div class=" w60">
				  <div class="divGrow">
					<div class="col2 w60"><input type="text" placeholder="Número de Tarjeta Azteca"></div>
   ...
   <div ng-show="isSet(2)">
    ...
    <div class="lineaAfore">
      <table class="tblLineaAfore">
        <tr>
          ...
          <td>
            <span>Línea Azteca</span> <br>
            <span>01 800 040 7777</span> <br> <span>55 54 47 88 10</span> <br>
            <span>Interior de la República y Área Metropolitana</span>
          </td>
        </tr>
      </table>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <div>Banco Azteca S.A. Institución de Banco Multiple</div>
      <div>Derechos Reservados 2018 (Términos y Condiciones de uso del portal)</div>
    </div>
  </div><!-- Fin page -->
  </div><!-- Fin page -->
  ...
  <div id="modalAviso" class="modal">
    <div class="cuadroPrueba cuadroM">
      ...
      <div class="contModal">
        ...
        <br><br>
        La innovación y la creatividad son parte esencial en la construcción de un México mejor,  asi que <strong>Agradecempos tu participación </strong> y te deseamos la mejor de las suertes
        <br><br>
